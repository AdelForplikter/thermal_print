...
def create_image(width=320, height=240, headline="", text="Normal Text", cut=False, headlinesize=32, textsize=22, marginleft=10, margintop=5):
    try:
        ...
        font_headline_size = headlinesize
        font_text_size = textsize
        ...
        if text:
            draw.text((marginleft, margintop + headlinesize), text, font=font_text, fill=text_color)
...
# create_40x20_image("Sokker")
# create_40x20_image("Ullsokker")
# create_40x20_image("Boksershorts")
# create_40x20_image("Bukser")
# create_40x20_image("Lange Ermer")
# create_40x20_image("T-skjorter")
